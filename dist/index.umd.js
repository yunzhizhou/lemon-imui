...
function fastDone(event, callback) {
  if (isFunction(event)) {
    event(function () {
      callback();
    });
...
/* harmony default export */ var contactvue_type_script_lang_js_ = ({
  ...
  render: function render() {
    ...
    return h("div", {
      ...
      "on": {
        "click": function click(e) {
          return _this._handleClick(e, contact);
        }
      }
    }, [h("lemon-badge", {
      "attrs": {
        ...
        "native-on-click": function nativeOnClick(e) {
          return _this._handleBubbleClick(e, contact);
        }
      },
      ...
      "attrs": {
        "size": 40,
        "native-on-click": function nativeOnClick(e) {
          return _this._handleAvatarClick(e, contact);
        },
        "src": contact.avatar
      }
    })]), h("div", {
...
/* harmony default export */ var editorvue_type_script_lang_js_ = ({
  ...
  created: function created() {},
  mounted: function mounted() {//this.$refs.fileInput.addEventListener("change", this._handleChangeFile);
  },
  computed: {},
  watch: {},
  render: function render() {
    ...
    return h("div", {
    ...
    }, [emojiData.length > 0 && h("lemon-popover", {
      "class": "lemon-editor__emoji"
    }, [h("template", {
      "slot": "content"
    }, [this._renderEmojiTabs()]), h("div", {
      ...
      "on": {
        "click": function click() {
          return _this._handleSelectFile("*");
        }
      }
    }, [h("i", {
      ...
      "on": {
        "click": function click() {
          return _this._handleSelectFile("image/*");
        }
      }
    }, [h("i", {
  ...
  methods: {
      ...
      var renderImageGrid = function renderImageGrid(items) {
        return items.map(function (item) {
          return h("img", {
            ...
            "on": {
              "click": function click() {
                return _this2._handleSelectEmoji(item);
              }
            }
          });
        });
    ...
    _handleSelectFile: function () {
      var _handleSelectFile2 = _asyncToGenerator(
      /*#__PURE__*/
      ...
      function _handleSelectFile(_x) {
        return _handleSelectFile2.apply(this, arguments);
      }

      return _handleSelectFile;
    }(),
  ...
  render: function render() {
    ...
    return h("div", {
        ...
        node.push(h("lemon-message-event", helper_default()([{}, {
          "attrs": {
            message: {
              id: "__time__",
              type: "event",
              content: _this.timeFormat(message.sendTime)
            }
          }
        }])));
      }
      ...
      node.push(h(tagName, helper_default()([{
        ...
        "attrs": {
          timeFormat: _this.msecRange > 0 ? function () {} : _this.timeFormat,
          message: message,
...
/* harmony default export */ var basicvue_type_script_lang_js_ = ({
  ...
  render: function render() {
    ...
    }, [this.useScopedSlots("content", this.message)]), h("div", {
  ...
  methods: {
    ...
    useScopedSlots: function useScopedSlots(name, params) {
      var defVnode = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
      var context = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : this;
      return context.$scopedSlots[name] ? context.$scopedSlots[name](params) : defVnode;
    }
  }
});
...
var DEFAULT_MENU_LASTMESSAGES = "lastMessages";
...
var CacheContactContainer = new memory_MemoryCache();
var CacheMenuContainer = new memory_MemoryCache();
var CacheMessageLoaded = new memory_MemoryCache();
...
/* harmony default export */ var componentsvue_type_script_lang_js_ = ({
  ...
  computed: {
    currentMessages: function currentMessages() {
      return componentsvue_type_script_lang_js_messages[this.currentContactId] || [];
    },
  ...
  methods: {
    ...
    appendMessage: function appendMessage(message) {
      var contactId = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.currentContactId;
    ...
    _emitPullMessages: function _emitPullMessages(next) {
      ...
      this.$emit("pull-messages", this.currentContact, function (messages) {
        ...
        CacheMessageLoaded.set(_this6.currentContactId, isEnd);
    ...
    _renderWrapper: function _renderWrapper(children) {
      var h = this.$createElement;
      return h("div", {
        "class": ["lemon-wrapper", this.drawerVisible && "lemon-wrapper--drawer-show"]
      }, [children]);
    },
    ...
    _renderSidebarMessage: function _renderSidebarMessage() {
      ...
      return this._renderSidebar([useScopedSlot(this.$scopedSlots["message-sidebar"]), this.lastMessages.map(function (contact) {
    ...
    _renderContact: function _renderContact(props, onClick) {
      var _this10 = this;
      ...
      var click = function click() {
        fastDone(customClick, function () {
          onClick();

          _this10._customContainerReady(renderContainer, CacheContactContainer, contactId);
        });
      };
    ...
    _renderSidebarContact: function _renderSidebarContact() {
      ...
      var h = this.$createElement;
      var prevIndex;
      return this._renderSidebar([useScopedSlot(this.$scopedSlots["contact-sidebar"]), this.contacts.map(function (contact) {
        ...
        var node = [contact.index !== prevIndex && h("p", {
          ...
          return _this11.changeContact(contact.id);
        })];
    ...
    _renderContainer: function _renderContainer() {
      ...
      for (var name in CacheContactContainer.get()) {
      ...
      for (var _name in CacheMenuContainer.get()) {
        nodes.push(h("div", {
          "class": cls,
          "directives": [{
            name: "show",
      ...
      }, [useScopedSlot(this.$scopedSlots["contact-title"], curact.displayName, curact)])]), h("lemon-messages", {
        "ref": "messages",
        "attrs": {
    ...
    _addMessage: function _addMessage(data, contactId, t) {
      ...
      (_messages$contactId = componentsvue_type_script_lang_js_messages[contactId])[type].apply(_messages$contactId, _toConsumableArray(data)); //console.log(messages[contactId]);
     ...
     */
    changeContact: function changeContact(contactId, menuName) {
      var _this13 = this;
    ...
    updateMessage: function updateMessage(messageId, contactId, data) {
      ...
      if (index !== -1) {
        ...
        console.log("--------", componentsvue_type_script_lang_js_messages[contactId][index]);
      ...
      if (Array.isArray(data)) {
        ...
        menus = data.map(function (item) {
          ...
          if (item.renderContainer) {
            _this14._customContainerReady(item.renderContainer, CacheMenuContainer, item.name);
          }
